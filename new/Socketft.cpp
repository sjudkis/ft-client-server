...
char *Socketft::getHost()
{
    return host;
}
char *Socketft::getPort()
{
    return port;
}
...
Socketft *Socketft::accept_connection()
{
    ...
    Socketft *newConn = new Socketft(host_name, newfd);
    return newConn;
}
...
*/
bool Socketft::send_message(const char *message)
{
